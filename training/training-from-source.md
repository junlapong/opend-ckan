# วิธีการติดตั้ง CKAN 2.9 จาก Source (สำหรับการอบรม)
```sh
#หมายเหตุ การใช้คำสั่ง sudo ในครั้งแรกต้องมีการใส่ password ของ vm
```
...
### 15. ติดตั้งและตั้งค่า [CKAN Extensions](training-extensions.md)
